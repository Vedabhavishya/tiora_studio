...
export const metadata = {
  title: "Privacy Policy & Terms - Ashwaah",
  description: "Privacy policy and terms of service for Ashwaah custom fit apparel.",
};
      ...
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-playfair font-bold text-[#1B3022] leading-tight mb-4 flex items-center justify-center gap-3">
            Privacy Policy & Terms <Sparkles size={24} className="text-[#C5A059]" />
          </h1>
